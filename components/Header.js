...
const PostCreation = ({ isWhite, style, navigation }) => (
...
class Header extends React.Component {
  ...
  renderRight = () => {
    ...
    if (title === 'Title') {
      return [
        ...
        <PostCreation key="post" navigation={navigation} isWhite={white} />,
    ...
    switch (title) {
      ...
      case 'Profile':
        return [
          <BasketButton key="basket-deals" navigation={navigation} isWhite={white} />,
          <PostCreation key="basket-deals" navigation={navigation} isWhite={white} />,
  ...
  renderHeader = () => {
    ...
    if (search || tabs || options) {
      return (
        <Block center style={styles.headerupper}>
