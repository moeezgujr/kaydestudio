...
function ProfileStyle28() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#f1f5f7' }}>
      <ImageBackground
        source={{ uri: storageImageUrl('profile', 'profile_28_header.jpg') }}
      ...
      >
        ...
        >
          ...
          />
          <Image
            source={require('../assets/icon/ic_profile4.png')}
        ...
        >
          <Image
            source={require('../assets/icon/ic_activity29_location.png')}
      ...
      <ScrollView>
        ...
        >
          <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#616161', marginBottom: 10 }}>
            ABOUT ME
          </Text>
          <Text style={{ fontSize: 14, color: '#9e9e9e', lineHeight: 20 }}>
            Weasel maternal dove far the jeepers goodness inconsiderately spelled so ubiquitous
            amused knitted and altruistic amiable far much toward.
          </Text>
          <View style={{ marginTop: 15, flexDirection: 'row', alignItems: 'center' }}>
            <Image
              source={require('../assets/icon/ic_home_black.png')}
              style={{ width: 12, height: 12, resizeMode: 'contain' }}
            />
            <Text style={{ flex: 1, fontSize: 14, color: '#616161', marginLeft: 8 }}>
              www.angelo.com
            </Text>
            <Image
              source={require('../assets/icon/ic_dribbble.png')}
              style={{ width: 12, height: 12, resizeMode: 'contain' }}
            />
            <Text style={{ flex: 1, fontSize: 14, color: '#616161', marginLeft: 8 }}>
              michael-angelo
...
function ItemData({ title, onPress }) {
  return (
    <TouchableOpacity
      onPress={() => onPress('button ' + title + ' clicked')}
      style={{
        width: '100%',
        paddingVertical: 20,
        flexDirection: 'row',
    ...
    >
      ...
      <Image
        source={require('../assets/icon/ic_chevron_right.png')}
