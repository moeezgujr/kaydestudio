            ...
            <Block style={{ top: height * 0.15 }}>
              <Block>
                <Text
                  ...
                  color="#ffffff"
                >
                  Interested In Being An Affiliate, Or A Partnership With Kayde Studios? Send Us A
                  Quick Message And We’ll Get Back To You To Discuss Details.{' '}
                </Text>
                ...
                <Block row space="around">
                  <Block middle>
                    <Text
                      size={15}
                      color="white"
                      style={{ marginBottom: 30, marginTop: -20, fontFamily: 'montserrat-bold' }}
                    >
                      Give us a call
                    </Text>
