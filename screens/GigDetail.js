...
import MultiColumnView from "../screens/components/MultiColumnView";
    ...
    return (
        <View style={{flex: 1, backgroundColor: '#f1f5f7'}}>
            ...
            <MaterialButton title='Hire'
                            style={{marginHorizontal: 15, marginBottom: 15, marginTop: 15, backgroundColor: '#B8A253'}}
...
function StatusProgressBar({progress, total, style}) {
    ...
    return (
        <View style={[{flexDirection: 'row'}, style]}>
            <View style={{height: 4, width: width, backgroundColor: '#B8A253'}}/>
